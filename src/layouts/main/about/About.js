...
function About() {
  ...
  return (
    <div className="home-about my-5 py-5 shadow-lg" id="section2">
      <Container>
          ...
          <Col sm="12" md="6">
            <div className="left-box">
              <div className="left-item-box">
                {" "}
                <img src={ImgOne} alt="some data" />{" "}
                <img src={ImgTwo} alt="some data" />{" "}
              </div>
              <div className="right-item-box">
                {" "}
                <img src={ImgThree} alt="some data" />{" "}
                <img src={ImgFour} alt="some data" />{" "}
              </div>
            </div>
          </Col>
          <Col sm="12" md="6">
